...
1. 需求：展示默认第一个省，第一个城市，第一个地区在下拉菜单中
   ...
   ![image-20230222173109762](/img/ajax/day04/images/image-20230222173109762.png)
...
3. 好处：通过链式调用，解决回调函数嵌套问题
   ...
   ![image-20230222173851738](/img/ajax/day04/images/image-20230222173851738.png)
...
2. 做法：每个 Promise 对象中管理一个异步任务，用 then 返回 Promise 对象，串联起来
   ...
   ![image-20230222174946534](/img/ajax/day04/images/image-20230222174946534.png)
...
4. 概念：执行代码和收集异步任务的模型，在调用栈空闲，反复调用任务队列里回调函数的执行机制，就叫事件循环
   ...
   */
   ...
   ![image-20230222182338992](/img/ajax/day04/images/image-20230222182338992.png)
...
1. 需求：请根据掌握的事件循环的模型概念，分析代码执行过程
   ...
   */
   ...
   ![image-20230222183656761](/img/ajax/day04/images/image-20230222183656761.png)
...
3. 宏任务和微任务具体划分：
   ...
   ![image-20230222184920343](/img/ajax/day04/images/image-20230222184920343.png)
...
4. 事件循环模型
   ...
   */
   ...
   ![image-20230222184949605](/img/ajax/day04/images/image-20230222184949605.png)
...
![image-20230222185205193](/img/ajax/day04/images/image-20230222185205193.png)
...
1. 需求：请切换到对应配套代码，查看具体代码，并回答打印顺序（锻炼事件循环概念的理解，阅读代码执行顺序_）
   ...
   ![image-20230222185939276](/img/ajax/day04/images/image-20230222185939276.png)
...
1. 概念：合并多个 Promise 对象，等待所有同时成功完成（或某一个失败），做后续逻辑
   ...
   ![image-20230222190117045](/img/ajax/day04/images/image-20230222190117045.png)
...
3. 需求：同时请求“北京”，“上海”，“广州”，“深圳”的天气并在网页尽可能同时显示
   ...
   ![image-20230222190230351](/img/ajax/day04/images/image-20230222190230351.png)
...
1. 需求：尽可能同时展示所有商品分类到页面上
   ...
   ![image-20230222191151264](/img/ajax/day04/images/image-20230222191151264.png)
...
1. 需求：完成省市区切换效果
   ...
   ![image-20230222191239971](/img/ajax/day04/images/image-20230222191239971.png)
